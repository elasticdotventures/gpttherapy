...
class TestIntegration:
    ...
    def test_load_real_game_configs(self, ai_agent_with_real_configs):
    ...
    def test_system_prompt_with_real_config(self, ai_agent_with_real_configs):
    ...
    def test_user_prompt_formatting(self, ai_agent_with_real_configs):
    ...
    def test_intimacy_prompt_differences(self, ai_agent_with_real_configs):
    ...
    def test_fallback_responses_are_appropriate(self, ai_agent_with_real_configs):
    ...
    def test_initialization_response_loads_templates(self, ai_agent_with_real_configs):
        ...
        assert 'player@example.com' in dungeon_response or 'adventurer' in dungeon_response.lower()
        ...
        assert 'couple@example.com' in intimacy_response or 'therapy' in intimacy_response.lower()
...
class TestConfigValidation:
    ...
    def test_config_files_exist(self):
        ...
        assert (dungeon_dir / "init-template.md").exists(), "Dungeon init-template.md missing"
        assert (dungeon_dir / "invite-template.md").exists(), "Dungeon invite-template.md missing"
        
        # Check intimacy files  
        intimacy_dir = games_dir / "intimacy"
        assert (intimacy_dir / "AGENT.md").exists(), "Intimacy AGENT.md missing"
        assert (intimacy_dir / "init-template.md").exists(), "Intimacy init-template.md missing"
        assert (intimacy_dir / "invite-template.md").exists(), "Intimacy invite-template.md missing"
    
    def test_agent_configs_have_required_sections(self):
    ...
    def test_init_templates_have_placeholders(self):
