...
class TestLambdaHandler:
            ...
            "Records": [
                {
                    ...
                    "ses": {
                        ...
                        "receipt": {
                            "recipients": ["test@dungeon.promptexecution.com"]
                        }
                    }
                }
            ]
    ...
    def test_lambda_handler_error(self):
        ...
        with patch('src.lambda_function.process_ses_email', side_effect=Exception("Test error")):
            result = lambda_handler(event, Mock())
...
class TestSessionExtraction:
    ...
    def test_extract_session_info_with_session_id(self):
    ...
    def test_extract_session_info_no_session(self):
    ...
    def test_extract_session_info_multiple_recipients(self):
        """Test with multiple recipients, one with session ID."""
        recipients = [
            "general@promptexecution.com",
            "456@intimacy.promptexecution.com"
        ]
...
class TestEmailProcessing:
    ...
    def test_process_ses_email_existing_session(self, mock_extract, mock_process_turn, mock_send):
    ...
    @patch('src.lambda_function.extract_session_info')
    def test_process_ses_email_new_session(self, mock_extract, mock_init, mock_send):
        ...
        record = {
            "ses": {
                ...
                "receipt": {
                    "recipients": ["dungeon@promptexecution.com"]
                }
            }
        }
