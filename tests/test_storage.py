...
class TestStorageManager:
    ...
    def test_test_prefix(self, storage_manager):
    ...
    def test_create_session(self, storage_manager, sample_session_data, mock_aws_clients):
    ...
    def test_get_session(self, storage_manager, mock_aws_clients):
    ...
    def test_get_session_not_found(self, storage_manager, mock_aws_clients):
    ...
    def test_update_session(self, storage_manager, mock_aws_clients):
        """Test session update."""
        mock_table = mock_aws_clients['table']
    ...
    def test_add_player_to_session(self, storage_manager, mock_aws_clients):
    ...
    def test_save_turn(self, storage_manager, sample_turn_data, mock_aws_clients):
        """Test saving a turn."""
        mock_table = mock_aws_clients['table']
        mock_table.put_item.return_value = {}
        mock_table.update_item.return_value = {}
    ...
    def test_get_session_turns(self, storage_manager, mock_aws_clients):
    ...
    def test_get_latest_turn(self, storage_manager, mock_aws_clients):
    ...
    def test_create_player(self, storage_manager, mock_aws_clients):
    ...
    def test_save_game_state(self, storage_manager, mock_aws_clients):
    ...
    def test_load_game_state(self, storage_manager, mock_aws_clients):
        """Test loading game state from S3."""
        mock_s3 = mock_aws_clients['s3']
        state_data = {"current_location": "forest", "inventory": ["sword"]}
        mock_response = {'Body': Mock()}
        mock_response['Body'].read.return_value.decode.return_value = json.dumps(state_data)
    ...
    def test_load_game_state_not_found(self, storage_manager, mock_aws_clients):
    ...
    def test_archive_email(self, storage_manager, mock_aws_clients):
...
class TestUtilityFunctions:
    ...
    def test_extract_session_id_simple(self):
...
class TestErrorHandling:
    ...
    def test_dynamodb_error_propagation(self, storage_manager, mock_aws_clients):
    ...
    def test_s3_error_propagation(self, storage_manager, mock_aws_clients):
